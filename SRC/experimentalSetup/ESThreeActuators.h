...
// ESThreeActuators. ESThreeActuators is an experimental setup
...
class ESThreeActuators : public ExperimentalSetup
{
public:
    // constructors
    ESThreeActuators(int tag,
    ...
    // destructor
    virtual ~ESThreeActuators();
    
    // method to get class type
    const char *getClassType() const {return "ESThreeActuators";};
