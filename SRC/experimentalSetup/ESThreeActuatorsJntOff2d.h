...
// ESThreeActuatorsJntOff2d. ESThreeActuatorsJntOff2d is an experimental
// setup class with three actuators which control the two translational 
// and the rotational degree of freedom of a specimen. The setup accounts 
...
public:
    // constructors
    ESThreeActuatorsJntOff2d(int tag,
    ...
    ESThreeActuatorsJntOff2d(const ESThreeActuatorsJntOff2d& es);
