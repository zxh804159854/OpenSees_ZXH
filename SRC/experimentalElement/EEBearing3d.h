...
#define EEBearing3d_h

// Written: Andreas Schellenberg (andreas.schellenberg@gmail.com)
// Created: 01/14
// Revision: A
//
// Description: This file contains the class definition for EEBearing3d.
// EEBearing3d is an experimental bearing element defined by two nodes.
...
#define ELE_TAG_EEBearing3d 9958


class EEBearing3d : public ExperimentalElement
{
public:
    // constructors
    EEBearing3d(int tag, int Nd1, int Nd2, 
    ...
    const char *getClassType() const {return "EEBearing3d";};
