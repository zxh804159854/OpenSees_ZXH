...
echo.
echo Compiling udp_socket.c:
echo =======================
call del udp_socket.log
call del udp_socket.obj
call cl udp_socket.c /c /O2 /D_WIN32 /D_CRT_SECURE_NO_DEPRECATE >>udp_socket.log 2>&1
::call icl udp_socket.c /c /O2 /D_WIN32 /D_CRT_SECURE_NO_DEPRECATE >>udp_socket.log 2>&1
