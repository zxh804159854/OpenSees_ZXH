...
%
blkStruct.Name = 'Hybrid Simulation';

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'HybridSimLib';
...
Browser(2).Library = 'HybridSimLib';
Browser(2).Name    = 'Hybrid Simulation';
