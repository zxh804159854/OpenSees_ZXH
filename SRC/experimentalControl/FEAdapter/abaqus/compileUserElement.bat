...
echo ==============================
call ifort adapter_imp.for /c /O2 /DABQ_WIN86_64 /iface:cref /recursive /nologo /heap-arrays:1
rename adapter_imp.obj impUserElmt.obj
echo done compiling adapter_imp.for
